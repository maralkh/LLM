...
def create_llama_13b():
    """Create LLaMA 13B model"""
    config = LlamaConfig(
        vocab_size=32000,
        hidden_size=5120,
...
def create_llama_30b():
    """Create LLaMA 30B model"""
    config = LlamaConfig(
        vocab_size=32000,
        hidden_size=6656,
...
def create_llama_65b():
    """Create LLaMA 65B model"""
    config = LlamaConfig(
        vocab_size=32000,
        hidden_size=8192,
...
def create_llama2_7b():
    """Create LLaMA 2 7B model with extended context"""
    config = LlamaConfig(
        vocab_size=32000,
        hidden_size=4096,
        intermediate_size=11008,
...
def create_code_llama_7b():
    """Create Code Llama 7B model"""
    config = LlamaConfig(
        ...
        rms_norm_eps=1e-5,
        rope_theta=1000000.0,  # Different RoPE base for long context
    )
    return LlamaForCausalLM(config)